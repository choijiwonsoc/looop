...
const EVENT_TYPES = ['Wedding', 'Move', 'Conference', 'Party', 'Household', 'Other'];
...
export function CreateEventPage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-5 py-12 sm:py-16">
      <h1 className="text-4xl mb-2">Start a new board</h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <label className="flex items-start gap-2 text-sm text-ink-soft leading-relaxed">
          ...
          <span>This is ongoing — no end date (good for a household or recurring board)</span>
        </label>
