        ...
        <div className="mt-7 flex flex-col gap-4 rounded-xl border border-loop/15 bg-loop/5 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
          <div>
            ...
            <p className="mt-1 text-xs leading-5 text-ink-soft">
              Open Looop in ChatGPT's in-app browser and ask ChatGPT to
              manage an event for you.
            </p>
          </div>

          <div className="inline-flex shrink-0 items-center justify-center gap-2 rounded-lg bg-ink px-4 py-2.5 text-sm font-semibold text-bg">
            Open in ChatGPT
